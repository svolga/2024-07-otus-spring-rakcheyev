...
public class DatabaseChangelog {
    ...
    public void insertAuthors(MongockTemplate repository) {
    ...
    public void insertGenres(MongockTemplate repository) {
    ...
    public void insertComments(MongockTemplate repository) {
