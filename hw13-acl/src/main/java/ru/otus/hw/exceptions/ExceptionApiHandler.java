...
public class ExceptionApiHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    public ApiErrorDto handleMethodJdbcSQLIntegrityConstraintViolationException(MethodArgumentNotValidException e) {
        ...
        ApiErrorDto apiError = ApiErrorDto.builder()
                ...
                .timestamp(LocalDateTime.now())
                .build();
        log.info("handleMethodJdbcSQLIntegrityConstraintViolationException(ValidationException e) --> {}", apiError);
